...
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('교촌치킨', 8, '치킨하면 허니콤보!!!진짜 맛있어요ㅠㅠㅠ내일 또 먹어야지', 4, '2018-05-30 20:00:00', '2018-05-30 20:00:00', 1);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('네네치킨', 1, '치킨하면 네네치킨!!!진짜 맛있어요ㅠㅠㅠ내일 또 먹어야지', 4, '2018-06-20 20:00:00', '2018-06-20 20:00:00', 2);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('석촌치킨', 2, '치킨하면 석촌치킨ㅋㅋㅋ진짜 맛있어요ㅠㅠㅠ내일 또 먹어야지', 5, '2018-05-08 20:00:00', '2018-05-08 20:00:00', 3);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('방이치킨', 1, '치킨이 진짜 맛있었다ㅠㅠㅠㅠㅠ후라이드가 제일 맛있어요!!', 4, '2018-08-02 20:00:00', '2018-08-02 20:00:00', 4);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('잠실치킨', 2, '진짜 별로ㅋㅋㅋㅋㅋㅋ;;;다시는 안먹어야지', 2.5, '2018-05-03 20:00:00', '2018-05-03 20:00:00', 5);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('종완치킨', 1, '별로예요ㅠㅠㅠ이거보고 절대 시키지 마세요.', 1.5, '2018-07-02 20:00:00', '2018-07-02 20:00:00', 6);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('맥날버거', 8, '다시는 안먹어ㅠㅠㅠㅠ내돈', 1, '2018-05-19 20:00:00', '2018-05-19 20:00:00', 7);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('롯데버거', 4, '짱이에요', 5, '2018-05-12 20:00:00', '2018-05-12 20:00:00', 8);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('크롱버거', 5, '괜찮아요', 4.5, '2018-01-21 20:00:00', '2018-01-21 20:00:00', 9);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('포비버거', 5, '먹을만해요', 3.5, '2018-05-01 20:00:00', '2018-05-01 20:00:00', 10);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('주하버거', 7, '또먹을래요', 4.5, '2018-02-02 20:00:00', '2018-02-02 20:00:00', 11);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('교촌피자', 6, '허니콤보 맛잇어요', 4, '2018-05-03 20:00:00', '2018-05-03 20:00:00', 12);
insert into review (title, food_category_id, contents, star_point, written_time, updated_time, order_food_id) values ('주하피자', 4, '또먹을래요', 4.5, '2018-02-12 20:00:00', '2018-02-12 20:00:00', 13);
...
insert into chat_message (user_id, chat_id, contents, written_time) values (1, 1, '자바지기 채팅!!!', '2018-02-12 20:00:00');
insert into chat_message (user_id, chat_id, contents, written_time) values (3, 1, '권현아 채팅!!!', '2018-02-12 20:00:00');
insert into chat_message (user_id, chat_id, contents, written_time) values (4, 1, '송민석 채팅!!!', '2018-02-12 20:00:00');
insert into chat_message (user_id, chat_id, contents, written_time) values (5, 1, '박주하 채팅!!!', '2018-02-12 20:00:00');